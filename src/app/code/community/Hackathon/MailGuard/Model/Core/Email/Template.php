...
class Hackathon_MailGuard_Model_Core_Email_Template extends Mage_Core_Model_Email_Template {
    ...
    {
        $return = FALSE;
        Mage::dispatchEvent('email_template_send_before', array('email' => $this));
        if(!$this->getDoNotSend()){
            $return = parent::send($email, $name, $variables); // TODO: Change the autogenerated stub
        }
        Mage::dispatchEvent('email_template_send_after', array('email' => $this));
        return $return;
    }
}